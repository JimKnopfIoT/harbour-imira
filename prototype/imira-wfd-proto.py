...
LOCAL_IP = "192.168.157.100"
SINK_IP = "192.168.157.1"
RTSP_PORT = 7236
TS_FILE = "/opt/imira/imira-test.ts"
SERVER_RTP = 19000
...
class WFDSession:
    ...
    def handle_reply(self, first, head, body):
        ...
        if self.state == "init":
            ...
            self.state = "m4sent"
            m4 = (
                "wfd_video_formats: 00 00 02 02 00000020 00000000 00000000 00 0000 0000 11 none none\r\n"
                "wfd_audio_codecs: LPCM 00000002 00\r\n"
                "wfd_presentation_URL: rtsp://%s/wfd1.0/streamid=0 none\r\n"
                "wfd_client_rtp_ports: %s\r\n"
                % (LOCAL_IP, self.rtp_ports_line or
                   "RTP/AVP/UDP;unicast %d 0 mode=play" % (self.client_rtp_port or 1028)))
